 ...
 *
 * referenced: http://stackoverflow.com/questions/16882971/retrieve-entire-row-with-resultset
 */
...
public class Row {
    ...
    public void add(Object data, String sqlType) {
        ...
        try {
            ...
            lgr.log(Level.SEVERE, e.getMessage() + " Add the type " + sqlType + " to the TYPE hash map in the Entities.Row class.", e);
            throw e;
        }
    }
